  ...
  <body>
    ...
    WHERE document.date_cre LIKE '_____" . $month . "___'  AND document.type_doc LIKE '%" . $type . "'";
              ...
              function drawChart() {
                ...
                var dataArray1 = [
                  ['เดือน', 'เอกสารรับ', 'เอกสารส่ง', ],
                  ['มกราคม', <?php echo query_executer('01', 'รับ'); ?>, <?php echo query_executer('01', 'ส่ง'); ?>],
                  ['กุมภาพันธ์', <?php echo query_executer('02', 'รับ'); ?>, <?php echo query_executer('02', 'ส่ง'); ?>],
                  ['มีนาคม', <?php echo query_executer('03', 'รับ'); ?>, <?php echo query_executer('03', 'ส่ง'); ?>],
                  ['เมษายน', <?php echo query_executer('04', 'รับ'); ?>, <?php echo query_executer('04', 'ส่ง'); ?>],
                  ['พฤษภาคม', <?php echo query_executer('05', 'รับ'); ?>, <?php echo query_executer('05', 'ส่ง'); ?>],
                  ['มิถุนายน', <?php echo query_executer('06', 'รับ'); ?>, <?php echo query_executer('06', 'ส่ง'); ?>],
                  ['กรกฏาคม', <?php echo query_executer('07', 'รับ'); ?>, <?php echo query_executer('07', 'ส่ง'); ?>],
                  ['สิงหาคม', <?php echo query_executer('08', 'รับ'); ?>, <?php echo query_executer('08', 'ส่ง'); ?>],
                  ['กันยายน', <?php echo query_executer('09', 'รับ'); ?>, <?php echo query_executer('09', 'ส่ง'); ?>],
                  ['ตุลาคม', <?php echo query_executer('10', 'รับ'); ?>, <?php echo query_executer('10', 'ส่ง'); ?>],
                  ['พฤศจิกายน', <?php echo query_executer('11', 'รับ'); ?>, <?php echo query_executer('11', 'ส่ง'); ?>],
                  ['ธันวาคม', <?php echo query_executer('12', 'รับ'); ?>, <?php echo query_executer('12', 'ส่ง'); ?>]
                ];
