        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    $edit = "SELECT * FROM superdocument WHERE doc_id='$doc_id'" or die("ERROR:" . mysqli_error($con));
                    ...
                    <div class="container col-sm-4">
                        ...
                        <form method="post" action="formrecieve_update.php">
