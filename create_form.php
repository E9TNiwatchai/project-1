      ...
      <section id="main-content">
        <section class="wrapper">
          ...
          <body>
            ...
            <p>
              <h1>&nbsp;&nbsp;&nbsp;สร้างฟอร์มเอกสาร</h1>
            </p><br>

            <div class="container col-sm-4">

              <form method="post" action="createform.php" enctype="multipart/form-data">
                ...
                <div class="input-group">
                  <span class="input-group-addon">อัพโหลด</span>
                  <input type="file" class="form-control" name="path_doc">
                </div><br>
            ...
            <div class="container col-sm-10">
              <span class="input-group-">
                ...
                <button type="submit" name="submit" class="btn btn-success">สร้างฟอร์มเอกสาร</button>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
