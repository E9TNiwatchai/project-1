...
echo "<tbody>";
        ...
        echo "<td><center>".$row["document_id"]."</center></td>";
        echo "<td><center>".$row["date_cre"]."</center></td>";
        echo "<td><center>".$row["from_doc"]."</center></td>";
        echo "<td><center>".$row["reciever"]."</center></td>";
        echo "<td><center>".$row["title_doc"]."</center></td>";
        echo "<td><center>".$row["action_doc"]."</center></td>";
        echo "<td><center>".$row["notation"]."</center></td>";
        echo "<td><center>".$row["urgency_doc"]."</center></td>";
        echo "<td><center>".$row["type_doc"]."</center></td>";
        echo "<td><center><a href='' class='btn btn-danger'>แก้ไข</a></center></td>";
        echo "<td><center><a href='formin.php?d=del&ID=$row[0]' class='btn btn-danger'>ลบ</a></center></td>";
